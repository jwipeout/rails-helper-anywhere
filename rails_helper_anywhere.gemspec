...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Use rails helpers anywhere.}
  spec.description   = %q{Use helpers anywhere with the Helper class.}
  spec.homepage      = "https://github.com/jwipeout/rails_helper_anywhere"
  spec.license       = "MIT"
